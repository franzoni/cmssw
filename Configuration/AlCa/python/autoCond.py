autoCond = { 
    ...
    # GlobalTag for MC production (cosmics) with realistic conditions for full Phase1 2018 detector XXXXXX REDO THIS TO BE PUT IN DECO XXXX ???
    'phase1_2018_cosmics'      :   '90X_upgrade2018cosmics_realistic_peak_v14',
