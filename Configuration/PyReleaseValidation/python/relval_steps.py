...
steps['MinBias_13INPUT']={'INPUT':InputInfo(dataSet='/RelValMinBias_13/%s/GEN-SIM'%(baseDataSetRelease[5],),location='STD')}
...
#for 2015
step3Up2015Defaults = {'-s':'RAW2DIGI,L1Reco,RECO,EI,DQM',
...
step3Up2015Hal = {'-s'            :'RAW2DIGI,L1Reco,RECO,EI,DQM',
                 '--conditions'   :'auto:run2_mc', 
                 '--magField'     :'38T_PostLS1',
                 '--datatier'     :'GEN-SIM-RECO,DQMIO',
                  '--eventcontent':'RECOSIM,DQM',
...
steps['HARVEST']={'-s':'HARVESTING:dqmHarvesting',
                   '--conditions':'auto:run1_mc',
                   '--mc':'',
                   '--filetype':'DQM',
                   '--scenario':'pp'}
...
steps['HARVESTUP15']={'-s':'HARVESTING:dqmHarvesting', # todo: remove UP from label
                   '--conditions':'auto:run2_mc', 
                   '--magField'    : '38T_PostLS1',
                   '--mc':'',
                   '--customise' : 'SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1',
