...
workflows[4.17] = ['', ['RunMinBias2011A','HLTD','RECODreHLTRunMinBias2011A','HARVESTDreHLT','SKIMDreHLT']]
...
workflows[4.28] = ['',['HighMet2011A','HLTDSKIM','RECODreHLTHighMet2011A','HARVESTDreHLT']]
...
workflows[4.40] = ['',['RunMinBias2012A','HLTD','RECODreHLTRunMinBias2012A','HARVESTDreHLT']]
workflows[4.41] = ['',['RunTau2012A','HLTD','RECODreHLTRunTau2012A','HARVESTDreHLT']]
workflows[4.42] = ['',['RunMET2012A','HLTD','RECODreHLTRunMET2012A','HARVESTDreHLT']]
workflows[4.43] = ['',['RunMu2012A','HLTD','RECODreHLTRunMu2012A','HARVESTDreHLT']]
workflows[4.44] = ['',['RunElectron2012A','HLTD','RECODreHLTRunElectron2012A','HARVESTDreHLT']]
workflows[4.45] = ['',['RunJet2012A','HLTD','RECODreHLTRunJet2012A','HARVESTDreHLT']]
...
workflows[4.65] = ['',['RunJet2012C','HLTD','RECODreHLTRunJet2012C','HARVESTDreHLT']]
...
workflows[4.71] = ['',['RunMinBias2012D','HLTD','RECODreHLTRunMinBias2012D','HARVESTDreHLT']]
workflows[4.72] = ['',['RunMu2012D','HLTD','RECODreHLTRunMu2012D','HARVESTDreHLT']]
workflows[4.73] = ['',['RunPhoton2012D','HLTD','RECODreHLTRunPhoton2012D','HARVESTDreHLT']]
workflows[4.74] = ['',['RunEl2012D','HLTD','RECODreHLTRunEl2012D','HARVESTDreHLT']]
workflows[4.75] = ['',['RunJet2012D','HLTD','RECODreHLTRunJet2012D','HARVESTDreHLT']]
