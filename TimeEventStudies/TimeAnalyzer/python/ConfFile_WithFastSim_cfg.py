...
# with command line options: ZEE_8TeV_cfi --conditions auto:startup --fast -n 10 -s GEN,SIM,RECO
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('ZEE_8TeV_cfi nevts:10'),
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('TimeAnalyzer_WithFastSim_output.root')
                                   )
